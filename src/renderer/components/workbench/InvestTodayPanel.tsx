...
import {
  ...
  ChevronRight, Zap, ArrowRight, Search,
  FileCheck, BarChart3, LineChart,
} from 'lucide-react'
...
function QuickAction({ icon, title, desc, onClick, color }: {
  ...
  return (
    ...
    >
      <div className={`w-10 h-10 rounded-lg flex items-center justify-center bg-muted/50 ${color} shrink-0 group-hover:scale-105 transition-transform`}>{icon}</div>
      <div className="flex-1 min-w-0">
