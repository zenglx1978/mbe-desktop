...
export const SOLUTION_REGISTRY: SolutionConfig[] = [
  ...
  },
  {
    ...
    enabledTabs: ['chat', 'brands', 'workflows', 'tools', 'erp-sync', 'efficiency', 'dashboard', 'costs', 'scheduler'],
    onboarding: {
      questions: [
    ...
    tools: [
      ...
      { id: 'response-generator', type: 'doc-generator', name: '客服话术生成', icon: '💬',
        agent: 'cs', apiPath: '/api/cs/ai/response-generate',
      ...
      { id: 'product-compliance-check', type: 'document-ai', name: '商品合规检查', icon: '🔍',
        agent: 'cs', apiPath: '/api/cs/ai/product-compliance',
      ...
      { id: 'extreme-words-check', type: 'document-ai', name: '极限词检查', icon: '🚫',
        agent: 'growth', apiPath: '/api/growth/ai/extreme-words',
      ...
      { id: 'campaign-roi-calc', type: 'calculator', name: '活动 ROI 计算器', icon: '📈',
        agent: 'growth', apiPath: '/api/growth/calc/campaign-roi',
      ...
      { id: 'monthly-report-gen', type: 'doc-generator', name: '月度运营报告', icon: '📋',
        agent: 'growth', apiPath: '/api/growth/ai/monthly-report',
